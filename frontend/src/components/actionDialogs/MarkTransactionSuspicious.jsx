...
import { getTransaction, markTransactionSuspicious } from "../../apis/transactionsApi";
...
export function MarkTransactionSuspicious() {
    ...
    return (
        <div>
            ...
            > Mark a Transaction as Suspicious </Button>
            ...
            <Dialog open={isOpen} onClose={handleClose}>
                {!transaction ? (
                    ...
                    <DialogContent>
                        <DialogContentText>
                            Insert the ID of the transaction to mark is as suspicious or not suspicious
                        </DialogContentText>

                        <form
                            onSubmit={handleSubmit}
                            id="mark-suspicious-form">
                            <TextField
                                required
                                margin="dense"
                                id="id"
                    ...
                    <DialogActions>
                        ...
                        <Button type="submit" form="mark-suspicious-form" variant="contained">
                            Submit
                        </Button>
                    </DialogActions>
                    </>

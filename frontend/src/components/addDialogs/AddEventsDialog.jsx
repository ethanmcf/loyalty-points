      ...
      <Dialog open={isOpen} onClose={handleClose}>
        {!isCreated ? (
          <>
            ...
            <DialogContent>
              <DialogContentText>
                Events are created as unpublished. Only managers and superusers can manage event capacity and points.
              </DialogContentText>
          ...
          <>
            ...
            <DialogContent>
              <Alert severity="success" sx={{ mb: 2 }}>
                Event "{createdEvent.name}" (ID: {createdEvent.id}) has been created as unpublished.
              </Alert>
              {Object.keys(createdEvent).map((prop, index) => (
                prop !== 'description' && prop !== 'guests' && prop !== 'organizers' && (
                  <div key={index}>
                    <b>{prop}: </b>

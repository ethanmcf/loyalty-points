...
export async function markTransactionSuspicious(
  authToken,
  transactionId,
  suspicious
) {
  const res = await fetch(
    `${baseURL}/transactions/${transactionId}/suspicious`,
    {
      method: "PATCH",
      headers: {
...
export async function setTransactionCompleted(
  ...
  const res = await fetch(
    `${baseURL}/transactions/${transactionsId}/processed`,
    {
      method: "PATCH",
      headers: {
        "Content-Type": "application/json",
...
export async function getTransactions(
  ...
  const res = await fetch(
    `${baseURL}/transactions?$name=${name}&createdBy=${createdBy}&suspicious=${suspicious}&promotionalId=${promotionalId}&type=${type}&relatedId=${relatedId}&amount=${amount}&operator=${operator}&page=${page}&limit=${limit}`,
    {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
